...
# ---------------------- params for the map -----------------------------------------------
dockhub_num: int = 1  # the number of docking hub nodes on the map to transport
depot_num: int = 1  # the number of depot on the map, only one is chosen
customer_num: int = 5  # the number of customers in the map
